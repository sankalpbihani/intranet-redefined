<?php 
session_start();
if((isset($_SESSION['logged_in']))&&(isset($_SESSION['user_nm']))&&(isset($_SESSION['name']))&&(isset($_SESSION['roll_no'])))
{
...
<ul>
   ...
   <li class='active'><a href='submitted.php'><span>View Filled choices</span></a></li>
...
<div align='center'>
	...
	<tr>
		...
		<td><!--these division is for the flip feature of the fillling choices-->
            <div class="panel">
...
<div align='center'><label class='webmail' align='center'>You are logged in as <?php echo $username;?>@iitg.ernet.in</label></div>
<div  align='center'>
...
{	
	$sub=1;
	$query_insert="UPDATE `user_preference_electives` SET `pref1`='".$_POST['SubCat1']."',`tool`=".$sub.",`pref2`='".$_POST['SubCat2']."',`pref3`='".$_POST['SubCat3']."',`pref4`='".$_POST['SubCat4']."',`pref5`='".$_POST['SubCat5']."',`pref6`='".$_POST['SubCat6']."',`pref7`='".$_POST['SubCat7']."' WHERE `rollno`='".$rollno."' && `username`='".$name."'";
