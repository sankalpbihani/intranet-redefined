...
<div id="container">
    ...
    <?php
        ...
        $user=$hall=$sdate=$edate=$stime=$etime=$hallid="";
        $i=0;
        include_once '../connect.php';
        $con=getConnected($host,$user,$pass,$db);
        ...
        if($sdate<$edate || ($sdate==$edate && $etime>$stime)){
            ...
            if($i==0){
                ...
                $user=$_SESSION['user_nm'];
                mysqli_query($con,"INSERT INTO booking (userid,startdate,enddate,hallname,starttime,endtime) VALUES('$user',$sdate','$edate','$hall','$stime','$etime')");
            }
        } else {               
            $i=1;
